// Elbow calibration tool for a PCA9686-driven servo.
//
...
//   p <value>      -> set raw PCA9686 pulse directly
//   a <angle>      -> set approximate servo angle (0-180)
//   c <channel>    -> change PCA9686 channel
//
// Default channel is 2, which matches the elbow channel in the test UI.
...
void setup() {
  ...
  Serial.println("Elbow calibration ready");
  printHelp();
  printState();
}
